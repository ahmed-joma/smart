...
class NearLocationHotelsBody extends StatefulWidget {
  const NearLocationHotelsBody({super.key});

  @override
  State<NearLocationHotelsBody> createState() => _NearLocationHotelsBodyState();
}

class _NearLocationHotelsBodyState extends State<NearLocationHotelsBody> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (hotelHomeState is HotelHomeSuccess) {
        for (var hotel in hotelHomeState.hotelData.hotels.nearLocationHotels) {
      ...
      child: BlocBuilder<HotelHomeCubit, HotelHomeState>(
        builder: (context, state) {
          ...
          if (state is HotelHomeSuccess) {
            final nearLocationHotels =
                state.hotelData.hotels.nearLocationHotels;

            if (nearLocationHotels.isEmpty) {
              return Center(
                child: Column(
            ...
            return ListView.builder(
              ...
              itemCount: nearLocationHotels.length,
              itemBuilder: (context, index) {
                final hotel = nearLocationHotels[index];
