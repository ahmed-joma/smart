...
class UpcomingEventsBody extends StatefulWidget {
  const UpcomingEventsBody({super.key});

  @override
  State<UpcomingEventsBody> createState() => _UpcomingEventsBodyState();
}

class _UpcomingEventsBodyState extends State<UpcomingEventsBody> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (homeState is HomeSuccess) {
        for (var event in homeState.homeData.events.upcoming) {
      ...
      child: BlocBuilder<HomeCubit, HomeState>(
        builder: (context, state) {
          ...
          if (state is HomeSuccess) {
            final events = state.homeData.events.upcoming;
