...
class ExpiredEventsBody extends StatefulWidget {
  const ExpiredEventsBody({super.key});

  @override
  State<ExpiredEventsBody> createState() => _ExpiredEventsBodyState();
}

class _ExpiredEventsBodyState extends State<ExpiredEventsBody> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (homeState is HomeSuccess) {
        for (var event in homeState.homeData.events.expired) {
      ...
      child: BlocBuilder<HomeCubit, HomeState>(
        builder: (context, state) {
          ...
          if (state is HomeSuccess) {
            final events = state.homeData.events.expired;
